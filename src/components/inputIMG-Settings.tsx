    ...
    <>
      <Box
        sx={{
          ...
          width: "100%",
          height: "100%",
          borderRadius: border ? border : "0.625rem",
          // background: "#2C3248",
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {loading ? <CircularProgress /> : "CARGAR"}
              </Typography>
            </Button>
            <Button
              sx={{
            ...
            >
              ...
              >
                {loading ? <CircularProgress /> : "CANCELAR"}
              </Typography>
            </Button>
          </Box>
        </Box>
...
export default ImgInputSettings;
