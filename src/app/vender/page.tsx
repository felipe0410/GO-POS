...
const Page = () => {
  ...
  const theme = createTheme({
    palette: {
      primary: {
        main: colorPrimary,
        // Puedes definir otras propiedades del color principal si es necesario
        // light: '',
        // dark: '',
        // contrastText: '',
      },
  ...
  // Inicializa una variable para el total de unidades
  let totalUnidades = 0;

  // Recorre el array y suma las unidades de cada elemento
