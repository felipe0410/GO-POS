...
const Page = () => {
  ...
  React.useEffect(() => {
    const getAllProducts = async () => {
      try {
        await getAllProductsData(setData,'JfIsfUNN4bb9SV2DsF3S0LOBVBJ2');
      } catch (error) {
    ...
    <Box id="page products" sx={{ height: "78%", width:'95%', margin:'0 auto' , paddingLeft:{ xs:'17px', lg:'auto'} , marginTop:'10px' }}>
      ...
      <Box sx={{ marginTop: "2rem", height: "100%" }}>
        <Box>
          ...
          >
            Aqui encontraras un catalogo de los roductos actuales para
            mayoristas
          </Typography>
          <Box
        ...
        >
          ...
          >
            ...
            <Box
              sx={{ marginTop: "1.56rem", height: { xs: "90%", sm: "80%" } }}
            >
              {isTable ? (
                <>
                  <Box
                ...
                <ProductCards filteredData={currentDataPage} wholesale={true} />
              )}
              <Box
                id="pagination"
                sx={{
